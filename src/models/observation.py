...
class Observation:
    ...
    def create_vital_sign(
        patient_reference: str, vital_type: str, value: float, unit: str, **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        code_data = vital_codes.get(
            vital_type,
            {"system": "http://loinc.org", "code": "unknown", "display": vital_type},
        )

        code = {"coding": [code_data], "text": code_data.get("display", vital_type)}
