...
class FHIRClient:
    ...
    def create_resource(self, resource: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Successfully created {resource_type} with ID: {created.get('id')}")
            return created
    ...
    def search(self, resource_type: str, search_params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
