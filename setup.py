...
setup(
    ...
    project_urls={
        'Bug Reports': 'https://github.com/vijaytarun-blip/fhir-client/issues',
        'Source': 'https://github.com/vijaytarun-blip/fhir-client',
        'Documentation': 'https://github.com/vijaytarun-blip/fhir-client#readme',
    },
)